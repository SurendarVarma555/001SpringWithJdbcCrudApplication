...
public class EmployeeDAOImpl implements EmployeeDao {
	...
	public void updateEmployeeEmailById(String newEmail, int eid) {
		...
		int rowUpdated = jdbctemplate.update(SQL, newEmail, eid);
		if (rowUpdated > 0)
			System.out.println("No.Of Employees Updated:  " + rowUpdated);
	...
	public void getAllEmplyeesDetails() {
		List<Employee> employees = (List<Employee>) jdbctemplate.query("SELECT * FROM Employee", new EmployeeRowMapper());
